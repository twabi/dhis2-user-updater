        ...
        if(uploadedFile == null){
            ...
            sheetState.map((sheet, x) => {
                //if(sheet.sheetName === "Dedza"){
                    ...
                    var firstIndex = sheet.rows[0].findIndex(x => x&&x.toLowerCase() === "first name");
                    var lastIndex = sheet.rows[0].findIndex(x => x&&x.toLowerCase() === "surname");
                    var userIndex = sheet.rows[0].findIndex(x => x&&x.toLowerCase() === "username");
